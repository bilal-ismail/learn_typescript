let names: string[] = ["Imran Khan", "Muhammad Ali Jinnah", "Arshad Sharif", "Dr. Arif Alvi"];
...
let appology_message: string = "Sincere apologies, due to limited space we are unable to invite all guests to the event.";
